...
namespace P2_2020PM606_2020TD601.Controllers
{
    public class generosController : Controller
    {
        ...
        public generosController(covid2023DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.generos != null ? 
                          ...
                          Problem("Entity set 'covid2023DbContext.generos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'covid2023DbContext.generos'  is null.");
            }
            var generos = await _context.generos.FindAsync(id);
            if (generos != null)
            {
